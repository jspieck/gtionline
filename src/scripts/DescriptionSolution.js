...
export class DescriptionSolution {
  ...
  makeDescriptionConversion() {
    let solution;
    let modus;
    let number;
    if (Array.isArray(this.watcher)) {
      solution = this.watcher[this.watcher.length - 1].steps.Result.data.resultNumber;
      modus = this.watcher[this.watcher.length - 1].steps.Modus.data.modus;
      number = this.watcher[this.watcher.length - 1].steps.Input.data.number;
    } else {
      solution = this.watcher.steps.Result.data.resultNumber;
      modus = this.watcher.steps.Modus.data.modus;
