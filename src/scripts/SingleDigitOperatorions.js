...
export const DivisionBaseNSingleDigit = // TODO: Zeus, zu erledigen
  /*#__PURE__*/
  function () {
    function DivisionBaseNSingleDigit(n, d) {
      _classCallCheck(this, DivisionBaseNSingleDigit);

      if (d < 0 || d >= n.base) {
        console.log("DivisionBaseNSingleDigit(Number, Digit): Base of n(".concat(n.base, ") and d(").concat(d, ") are not compatible."));
      }

      this.result = this._divide(n, d);
    }

    _createClass(DivisionBaseNSingleDigit, [{
      key: "_divide",
      value: function _divide(n, d) {
        const offset = n.offset;
        const base = n.base;
        const isNegative = n.isNegative;
        let overflow = [0];
    ...
    return DivisionBaseNSingleDigit;
  }();
