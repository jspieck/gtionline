...
export const i18n = new VueI18n({
  ...
  messages: {
    de: {
      ...
      PowerToPower: 'Die Konvertierung eines beliebigen Zahlensystems in ein beliebiges (nicht dezimal), erfolgt durch zweiteilige Konvertierung über das Dezimalsystem.',
